...
router.post('/update', function (req, res) {
    ...
    employeeModel.findByIdAndUpdate(req.body.id, { firstname: req.body.fname, lastname: req.body.lname, email: req.body.email, department: req.body.department }, function (err, model) {
        console.log(err);
        res.redirect('/employee');
    });
});
